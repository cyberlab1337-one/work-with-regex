...
data_dir = "/home/mkulbat/projects/data"
...
def main():
  ...
  csv_file_location = '/home/mkulbat/projects/Work with regex/user_emails.csv'
  report_file = Path(data_dir) / 'updated_user_emails.csv'
